# PH First Maker Comment — 톤 3안 (캡틴 5/4 결정용)

- **작성**: F(그로스 마케터) · 2026-05-02 (D-4)
- **사용 시점**: 5/6 (수) KST 16:01 PH 발사 직후 즉시 첫 댓글로 게시
- **선택 방법**: 아래 1/2/3 중 하나 선택 → 클립보드 복사 → PH 댓글창 붙여넣기
- **참고**: 어떤 안을 골라도 메모리 `project_ai_disclosure_decision.md`(AI 비공개)는 자동 준수됨

---

## ✅ 캡틴 최종 결정: **3안 (스토리텔링)** — 2026-05-02

5/6 D-day에 아래 §3안 본문을 그대로 PH 댓글창에 복사·붙여넣기.

---

## 1안 — 친근한 "Hey doha" 톤 (분량 약 150자)

> **추천 페르소나**: 인디 해커, 솔로 메이커. 톤은 가볍고 솔직. PH 정통 스타일.

```
Hey PH — doha here, the dev behind MergeUi.
...
**언제 고를까**:
- PH·Indie Hackers 정통 톤을 원할 때
- 캡틴이 댓글 응대 시 가벼운 영어로 응답할 의향이 있을 때
- "친구가 만든 것 같은" 느낌으로 호감 유도

---

## 2안 — 전문적 톤 (분량 약 175자)

> **추천 페르소나**: 시리어스 SaaS 메이커. 신뢰감·근거 중심. 엔터프라이즈 개발자도 안심.

```
Hi Product Hunt — maker of MergeUi.
...
**언제 고를까**:
- 엔터프라이즈·시니어 개발자 비중이 높을 것으로 예상될 때
- 신뢰감과 기술 근거(WCAG AA, Lighthouse 등)를 전면에 내세울 때
- 캡틴이 응대 시 정중하고 정보 밀도 높은 답변을 선호할 때

---

## 3안 — 스토리텔링 톤 (분량 약 200자)

> **추천 페르소나**: 1인 디자이너. 진정성 + 감정 훅. 바이럴 잠재력 최대. F(그로스) 권장.

```
Two years ago I made the same dashboard for the third time and finally admitted: I am the bottleneck.
...
I will be in the comments. Tell me what dashboard pain finally made you click into this post — that is the next thing I will build.
```

**언제 고를까**:
- 바이럴·소셜 공유 가능성을 최대화하고 싶을 때 (F 권장)
- PH 외에 X/LinkedIn에서도 댓글 인용이 노출될 가능성 고려
- 캡틴이 자기 스토리를 솔직하게 노출해도 괜찮을 때
- 첫 50명 Early Bird를 "초기 후원자" 프레임으로 강하게 잡고 싶을 때

---

## F 권장 (참고)

**1순위: 3안 (스토리텔링)** — PH 알고리즘은 댓글 길이·인용·감정 훅에 우호적. 1인 메이커 페르소나(Tailwind UI · Cassidy Williams 모델)와 정합.
**2순위: 1안 (친근)** — 응대 부담 최소, PH 정통 톤. 첫 PH 런칭 시 안전한 선택.
**3순위: 2안 (전문)** — 엔터프라이즈 타겟이 명확할 때만. PH보다 LinkedIn 톤에 가깝다는 우려.

---

## 사용 후 체크 (5/6 KST 16:05)

- [ ] PH 게시글 본문 발사 직후 1분 내 첫 댓글 게시
- [ ] 댓글 게시 후 GA4·Sentry 대시보드 동시 오픈
- [ ] 첫 응답 댓글은 게시 15분 내 (PH 알고리즘 상위 노출 핵심)
