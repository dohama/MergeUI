...
> 최근 커밋(2026-04-19)으로 GA4 측정 태그, 핵심 전환 이벤트, 쿠키 동의 배너(Consent Mode v2), Search Console 인증이 완료되어 기존 Explore 수집 결과에서 5건 감산됨.
...
| P-03 | 결제 UI 실제 동작 미연동 | ❌ 미착수 | pricing.html 결제 버튼이 가짜 | C+D | Lemonsqueezy Checkout 연동 |
